...
<head>
    ...
    <style>
        .dimensions-row { display: flex; gap: 0; }
        .dimensions-section { flex: 1; padding: 5px 0; margin: 0px; text-align: center; border-right: 1px solid #ccc; box-sizing: border-box; }";
        .dimensions-section:last-child { border-right: none; }";
        .dim-box { width: 20px; height: 20px; }";
        ...
        .top-bar { height: 80px; background-color: #f0f0f0; display: flex; align-items: center; padding: 0 20px; }
        .form-element { margin-right:   display: block; margin-bottom: 5px; }
